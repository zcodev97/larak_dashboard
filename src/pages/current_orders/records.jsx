...
import { FormatDateTime, SYSTEM_URL, formatDate } from "../../global";
...
function CurrentOrdersPage() {
  ...
  async function loadData(page = 1) {
    setLoading(true);
    await fetch(SYSTEM_URL + `admin_current_orders/?page=${page}`, {
      method: "GET",
      headers: {
    ...
    <>
      ...
      <div className="container">
        <p style={{ fontSize: "16px", fontWeight: "bold" }}>
          {data.count} {data.count > 1 ? "Current Orders" : "Current Order"}
        </p>
      </div>
                    ...
                    <tr key={item.vendor_id + Math.random() * 10}>
                      ...
                      <td>
                        <button
                          ...
                          onClick={() => {
                            navigate("/current_order_details", { state: item });
                          }}
                        >
                          <b>Details</b>
                        </button>
